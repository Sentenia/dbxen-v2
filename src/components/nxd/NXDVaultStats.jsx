    ...
    <div className="nxd-vault-stats fade-up fade-up-3">
      ...
      <div className="card nxd-card">
        ...
        <div className="stat-row">
          ...
          <span className="stat-value" style={{ color: 'var(--red)' }}>{fmt(protocolStats.nxdBurned)} NXDv2</span>
        </div>
        <div className="stat-row">
      ...
      <div className="card nxd-card">
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div className="stat-row"><span className="stat-label">Burn NXDv2</span><span className="stat-value" style={{ color: 'var(--red)' }}>1.5%</span></div>
        ...
        <div style={{ marginBottom: 16 }}>
          ...
          <div className="stat-row"><span className="stat-label">Buy + Burn NXDv2</span><span className="stat-value" style={{ color: 'var(--amber)' }}>50%</span></div>
        ...
        <div className="stat-row"><span className="stat-label">Max Supply</span><span className="stat-value">{maxSupFloat.toLocaleString()} NXDv2</span></div>
        <div className="stat-row"><span className="stat-label">NXDv2 Burned %</span><span className="stat-value" style={{ color: 'var(--red)' }}>{burnPct}%</span></div>
