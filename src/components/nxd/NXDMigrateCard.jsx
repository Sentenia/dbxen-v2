  ...
  return (
    <div className="nxd-card fade-up" style={{ maxWidth: 520, margin: '0 auto', textAlign: 'center', padding: '40px 32px', borderColor: 'var(--amber-glow)' }}>
      ...
      <p style={{ fontSize: 14, lineHeight: 1.7, color: 'var(--text-secondary)', margin: 0 }}>
        The NXDv2 migration bridge has been retired. To protect the NXDv2 ecosystem, new NXDv2 can only be obtained by depositing DXNv2 during the Community Sale Phase (CSP). This ensures every NXDv2 token is backed by freshly locked DXNv2, strengthening the protocol for all holders.
      </p>
    </div>
  );
}
